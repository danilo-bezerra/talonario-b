...
export function Suporte () {
  ...
  return (
    ...
    <VStack flex={1} alignItems="flex-start" bg="gray.600" px={8} pt={15}>
      ...
      InputLeftElement={<Icon as={<Ionicons name={"person"} color={colors.gray[300]} />} ml={4} />}
      />
     <Input
        mb={4}
        placeholder="E-mail"
      ...
      onChangeText={setMessage}/>
        <Modal isOpen={showModal} marginTop={0} marginBottom={"auto"} safeAreaTop={true}>
                <Button 
                  mb={4}
                  onPress={() => Linking.openURL(URL+name+"\nEmail: "+email+"\nMensagem: "+message)}
                  title={"WhatsApp"}
                  w={"50%"}/>
                <Button 
                  onPress={() => Linking.openURL('mailto:brenobrito984@gmail.com?subject=Suporte Talonario&body='+name+"\nEmail: "+email+"\nMensagem: "+message)}
                  title={"E-mail"}
                  mb={4}
                  w={"40%"}/>
                <Button 
